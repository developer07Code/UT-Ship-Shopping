...
public class SliderAdapetr extends PagerAdapter {


    Context c;
    RequestOptions options;
    LayoutInflater layoutInflater;
    private List<DashboardBean.DataDTO.SlidersDTO> _imagePaths;
    private LayoutInflater inflater;

    public SliderAdapetr(Context c, List<DashboardBean.DataDTO.SlidersDTO> imagePaths) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View viewLayout = inflater.inflate(R.layout.beanviewpager, container,false);
