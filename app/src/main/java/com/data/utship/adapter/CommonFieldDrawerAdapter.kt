...
class CommonFieldDrawerAdapter(var context: Activity, var list: ArrayList<MenuModel>, var rvClickListner: RvClickListner) : RecyclerView.Adapter<CommonFieldDrawerAdapter.MyViewHolder>(){
