...
class CommonFieldFavAdapter(var context: Activity, var list: ArrayList<MenuModel>, var rvClickListner: RvClickListner) : RecyclerView.Adapter<CommonFieldFavAdapter.MyViewHolder>(){
