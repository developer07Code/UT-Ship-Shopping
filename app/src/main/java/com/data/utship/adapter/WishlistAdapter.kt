...
class WishlistAdapter(var context: Activity, var list: ArrayList<MenuModel>, var rvClickListner: RvClickListner) : RecyclerView.Adapter<WishlistAdapter.MyViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder { // infalte the item Layout
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_wishlist_list, parent, false)
