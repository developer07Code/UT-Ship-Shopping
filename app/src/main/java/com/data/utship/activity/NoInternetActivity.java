...
import com.data.utship.utills.broadcastreceiver.ConnectivityListener;
...
public class NoInternetActivity extends AppCompatActivity implements ConnectivityListener.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.tvBackRetry);
    ...
    protected void onResume() {
      ...
      //  AppCon.getInstance().setConnectivityListener(this);
